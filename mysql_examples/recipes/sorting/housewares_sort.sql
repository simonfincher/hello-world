...
SELECT id, LEFT(id,3), SUBSTRING(id,4) + 0, RIGHT(id,2) FROM housewares2;


# Seek from the left, and then yank the rightmost segment
...
# Seek from the right, and then yank the leftmost segment
