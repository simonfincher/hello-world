#!/usr/bin/perl
# cvt_date.pl - Read input data, look for values that
# match a date format, convert them to another format

# Also converts 2-digit years to 4-digit years on request.  By default,
# assumes a transition point of 70, but this can be changed.
