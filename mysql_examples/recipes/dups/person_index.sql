...
# Table that includes no index; duplicate values are allowed
...
# is allowed to be NULL, so it's possible for multiple records with the
...
# Table that allows duplicate records with the same name but uses an
...
# Table that allows duplicate records with the same name but uses a
